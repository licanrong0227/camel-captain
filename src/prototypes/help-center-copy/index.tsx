...
const Component = forwardRef(function HelpCenter(
    ...
    const CHAPTERS = [
        ...
        { id: 'product-attr', title: '商品属性' },
        { id: 'product-sku', title: 'SKU管理' },
    ];
        ...
        <>
          <main className="help-center-shell">
                      ...
                      <div className="help-center-main">
                          ...
                          <section className="help-center-content" ref={scrollContainerRef}>
                              <div className="help-center-content-inner">
                                       ...
                                       >
                                           ...
                                           <div className="help-center-rich-media">
                                            ...
                                            <div className="help-center-info-box" style={{ background: '#EFF6FF', borderColor: '#BFDBFE' }}>
                                               <AlertCircle className="help-center-info-box-icon" size={20} />
                                               <div className="help-center-info-box-content">
                                                   <h3 className="help-center-info-box-title" style={{ color: '#1E40AF' }}>注意事项</h3>
                                                   <p className="help-center-info-box-text" style={{ color: '#1E3A5F' }}>
                                                       商品编码（SKU）在系统中具有唯一性，创建后不可修改。请提前规划好编码规则，建议采用「分类缩写-序号」格式，如 SHO-001。
                                                   </p>
                                               </div>
                                            </div>
                                            ...
                                            <div className="help-center-table-wrapper">
                                                <table className="help-center-table">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>商品名称</td>
                                                            <td style={{ color: '#EF4444', fontWeight: 500 }}>必填</td>
                                                            <td>不超过 120 个字符，支持中英文</td>
                                                        </tr>
                                                        <tr>
                                                            <td>商品编码</td>
                                                            <td style={{ color: '#EF4444', fontWeight: 500 }}>必填</td>
                                                            <td>系统唯一标识，创建后不可修改</td>
                                                        </tr>
                                                        <tr>
                                                            <td>所属分类</td>
                                                            <td style={{ color: '#EF4444', fontWeight: 500 }}>必填</td>
                                                            <td>支持多级分类选择，可快速搜索</td>
                                                        </tr>
                                                        <tr>
                                                            <td>商品主图</td>
                                                            <td style={{ color: '#EF4444', fontWeight: 500 }}>必填</td>
                                                            <td>至少上传 1 张，最多 10 张，支持拖拽排序</td>
                                                        </tr>
                                                        <tr>
                                                            <td>售价</td>
                                                            <td style={{ color: '#EF4444', fontWeight: 500 }}>必填</td>
                                                            <td>单位为人民币，支持小数点后两位</td>
                                                        </tr>
                                                        <tr>
                                                            <td>库存数量</td>
                                                            <td style={{ color: '#EF4444', fontWeight: 500 }}>必填</td>
                                                            <td>默认为 0，需大于 0 才可上架销售</td>
                                                        </tr>
                                                        <tr>
                                                            <td>商品描述</td>
                                                            <td style={{ color: 'var(--text-tertiary)' }}>选填</td>
                                                            <td>富文本格式，支持插入图片和表格</td>
                                                        </tr>
                                                        <tr>
                                                            <td>物流重量</td>
                                                            <td style={{ color: 'var(--text-tertiary)' }}>选填</td>
                                            ...
                                            <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-md)', marginBottom: 'var(--spacing-xl)' }}>
                                                <div style={{ background: 'var(--bg-sidebar)', borderRadius: 'var(--radius-md)', padding: 'var(--spacing-lg)' }}>
                                                    <h4 style={{ margin: '0 0 var(--spacing-sm) 0', fontSize: 'var(--font-size-md)', fontWeight: 600, color: 'var(--text-primary)' }}>Q：商品图片上传失败怎么办？</h4>
                                                    <p style={{ margin: 0, fontSize: 'var(--font-size-base)', color: 'var(--text-secondary)', lineHeight: 1.6 }}>
                                                        请检查图片格式是否为 JPG、PNG 或 WebP，文件大小是否超过 5MB。建议使用系统提供的图片裁剪工具调整尺寸后再上传。
                                                    </p>
                                                </div>
                                                <div style={{ background: 'var(--bg-sidebar)', borderRadius: 'var(--radius-md)', padding: 'var(--spacing-lg)' }}>
                                                    <h4 style={{ margin: '0 0 var(--spacing-sm) 0', fontSize: 'var(--font-size-md)', fontWeight: 600, color: 'var(--text-primary)' }}>Q：如何批量导入商品？</h4>
                                                    <p style={{ margin: 0, fontSize: 'var(--font-size-base)', color: 'var(--text-secondary)', lineHeight: 1.6 }}>
                                                        在商品列表页点击「批量导入」，下载标准模板填写商品数据后上传，系统将自动校验并导入。单次最多支持 500 条数据。
                                                    </p>
                                                </div>
                                                <div style={{ background: 'var(--bg-sidebar)', borderRadius: 'var(--radius-md)', padding: 'var(--spacing-lg)' }}>
                                                    <h4 style={{ margin: '0 0 var(--spacing-sm) 0', fontSize: 'var(--font-size-md)', fontWeight: 600, color: 'var(--text-primary)' }}>Q：草稿状态的商品可以编辑吗？</h4>
                                                    <p style={{ margin: 0, fontSize: 'var(--font-size-base)', color: 'var(--text-secondary)', lineHeight: 1.6 }}>
                                                        可以。草稿状态的商品支持任意修改。已上架的商品修改价格和库存会立即生效，修改基本信息需重新审核。
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                       ...
                                       <div
                                           id="product-category"
                                           ref={el => { sectionRefs.current['product-category'] = el; }}
                                           className="help-center-section"
                                       >
                                           <div className="help-center-section-header">
                                               <h1 className="help-center-section-title">
                                           ...
                                           <div className="help-center-rich-media">
                                               ...
                                               <p style={{ margin: '8px 0 0', fontSize: 'var(--font-size-sm)', color: 'var(--text-tertiary)', textAlign: 'center' }}>图3：分类管理操作演示</p>
                                           </div>
                                       </div>

                                       <div
                                           id="product-attr"
                                           ref={el => { sectionRefs.current['product-attr'] = el; }}
                                           className="help-center-section"
                                       >
                                           <div className="help-center-section-header">
                                               <h1 className="help-center-section-title">
                                           ...
                                           <div className="help-center-rich-media">
                                               ...
                                               <p style={{ margin: '8px 0 0', fontSize: 'var(--font-size-sm)', color: 'var(--text-tertiary)', textAlign: 'center' }}>图4：商品属性配置演示</p>
                                           </div>
                                       </div>

                                       <div
                                           id="product-sku"
                                           ref={el => { sectionRefs.current['product-sku'] = el; }}
                                           className="help-center-section"
                                       >
                                           <div className="help-center-section-header">
                                               <h1 className="help-center-section-title">
                                           ...
                                           <div className="help-center-rich-media">
                                               ...
                                               <p style={{ margin: '8px 0 0', fontSize: 'var(--font-size-sm)', color: 'var(--text-tertiary)', textAlign: 'center' }}>图5：SKU管理操作演示</p>
                                           </div>
                                        </div>
                              </div>
                          </section>
